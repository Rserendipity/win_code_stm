...
extern void OLED_ShowTIttle1(u8 x, u8 y);//显示湿度的符号

extern void OLED_ShowCHinese1(u8 x, u8 y);//显示汉字

extern void OLED_ShowCHinese2(u8 x, u8 y);
